...
function Humanoid(){
    return(
        <div className="normal-case">
            ...
            <p className="pt-5 pr-10 w-1/2">{`This project was done in the context of an advanced 3D modelling course. The aim of the project was to conceptualize, model and animate a humanoid character. The tools used were Blender, Adobe Substance Painter, Mixamo and Unity.`}</p>
